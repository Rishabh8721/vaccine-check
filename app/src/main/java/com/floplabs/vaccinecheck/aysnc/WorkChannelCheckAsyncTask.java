...
public class WorkChannelCheckAsyncTask extends AsyncTask<Void, Void, List<Slot>> {

    private static final String TAG = "work_channel_check_async_task";
    private final Context context;
    private final int districtId;
    private final JsonFilter jsonFilter;
    private final DateFormat dateFormat = new SimpleDateFormat("dd-MM-yyyy");

    public WorkChannelCheckAsyncTask(Context context, int districtId) {
